-- Repair migration for environments where V18 is marked as applied but the table is absent.
-- This migration is idempotent and only creates the Jira issue cache table when missing.
CREATE TABLE IF NOT EXISTS project_jira_issues (
...
CREATE INDEX IF NOT EXISTS idx_jira_issues_project_id
